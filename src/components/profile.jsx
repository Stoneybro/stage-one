...
function Profile() {
    ...
    <div className="profile">
        <div className="profile-wrapper"><div className="profile-img" onMouseOver={()=>sethover(true)} onMouseLeave={()=>sethover(false)}>{hover?<img src={pic} alt="profile picture" id="profile__img" />:<img src={choosepic} alt="choose profile picture" id="profile__img" />}
</div>
       </div>
